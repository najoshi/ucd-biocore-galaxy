...
def main():
	...
	if -1 < n:
		...
		#total, 'or', int(100. - discarded / float(total) * 100.), '%'
            sys.stdout.write('Kept ' + str(total - discarded) + ' of ' + str(total) + ' or ' + str(int(100. - discarded / float(total) * 100.)) + '%. ')
	    #print 'output in', output_name
	else: sys.stdout.write ('SKIPPED empty file ' + input_filename + '\n\n')
    ...
    sys.stdout.write ('fp rate estimated to be %1.3f .' % fp_rate)
