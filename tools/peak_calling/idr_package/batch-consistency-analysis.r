...
write.table(write.out.data, file=overlap.output, quote=FALSE, sep="\t")
...
write.table(idr.cut, file=npeaks.output, append=T, quote=F, row.names=F, col.names=F, sep="\t")
